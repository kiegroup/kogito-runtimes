...
public class MilestoneNodeInstanceWriter implements NodeInstanceWriter {

    @Override
    public boolean accept(NodeInstance value) {
        return value instanceof MilestoneNodeInstance;
    }

    @Override
    public Builder<?> write(MarshallerWriterContext context, NodeInstance value) {
        MilestoneNodeInstance nodeInstance = (MilestoneNodeInstance) value;
